...
![](/images/ghidra_install_homebrew.png)
...
![](/images/ask_analyze.png)
![](/images/check_analyzer.png)
...
![](/images/bin_info1.png)
![](/images/bin_info3.png)
...
![](/images/decompile1.png)
`L`을 눌러서 함수의 이름을 `main`으로 바꿔주도록 하겠습니다. 
![](/images/rename_func1.png)
...
![](/images/decompile_func_main.png)
...
![](/images/decompile_func_FUN_00101149.png)
...
![](/images/xor_datatype_opt.png)
![](/images/xor_datatype.png)
...
![](/images/xor_script.png)
![](/images/xor_script_manager.png)
![](/images/xor_bundle_manager.png)
![](/images/xor_bundle_select.png)
다음으로 `Script Manager` 우측 상단에 있는 흰 종이 모양의 `Create New Script` 버튼을 눌러 새로운 스크립트 작성을 시작합니다.
![](/images/xor_script_manager.png)
![](/images/xor_new_script_type.png)
...
![](/images/xor_new_script.png)
새로운 스크립트를 추가하면 다음과 같은 기본 편집 창이 나오게 됩니다.
![](/images/xor_expy_new.png)
...
![](/images/dynamic_set_b.png)
![](/images/dynamic_set_b2.png)
![](/images/dynamic_set_b3.png)
...
![](/images/dynamic_register_0xb.png)
...
![](/images/inside_b.png)
![](/images/inside_b2.png)
![](/images/inside_b3.png)

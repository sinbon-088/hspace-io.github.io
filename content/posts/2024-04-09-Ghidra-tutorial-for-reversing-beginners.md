...
![](ghidra_install_homebrew.png)

맥에서 기드라를 처음 실행하는 경우와 업데이트를 한 경우 아래와 같은 창이 나올 수 있습니다.  
![](excute_on_mac/error1.png)
![](excute_on_mac/error2.png)  
이를 해결하기 위해서는 finder에서 열기를 누르고, 열린 폴더 안에 있는 실행파일을 좌클릭한 뒤, 열기를 눌러주면 됩니다. 그리고 다시 실행하면 오류는 해결됩니다.
![](excute_on_mac/finder_open1.png)
![](excute_on_mac/finder_open2.png)
![](excute_on_mac/finder_decompile.png)
![](excute_on_mac/option.png)<!--사이즈 조절해서 파인더 이미지에 합치기-->
![](excute_on_mac/finder_gnu.png)
![](excute_on_mac/option.png)<!--사이즈 조절해서 파인더 이미지에 합치기-->
...
![](decompile_func_FUN_00101149.png)
...
![](xor_script.png)
![](xor_script_manager.png)
![](xor_bundle_manager.png)
![](xor_bundle_select.png)
다음으로 `Script Manager` 우측 상단에 있는 흰 종이 모양의 `Create New Script` 버튼을 눌러 새로운 스크립트 작성을 시작합니다.
![](xor_script_manager.png)
![](xor_new_script_type.png)
